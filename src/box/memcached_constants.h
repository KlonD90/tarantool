...
#define MEMCACHED_BIN_CMD_IS_QUITE(CMD) (		   \
		CMD == MEMCACHED_BIN_CMD_GETQ		|| \
		CMD == MEMCACHED_BIN_CMD_GETKQ		|| \
		CMD == MEMCACHED_BIN_CMD_SETQ		|| \
		CMD == MEMCACHED_BIN_CMD_ADDQ		|| \
		CMD == MEMCACHED_BIN_CMD_REPLACEQ	|| \
		CMD == MEMCACHED_BIN_CMD_DELETEQ	|| \
		CMD == MEMCACHED_BIN_CMD_INCRQ		|| \
		CMD == MEMCACHED_BIN_CMD_DECRQ		|| \
		CMD == MEMCACHED_BIN_CMD_QUITQ		|| \
		CMD == MEMCACHED_BIN_CMD_FLUSHQ		|| \
		CMD == MEMCACHED_BIN_CMD_APPENDQ	|| \
		CMD == MEMCACHED_BIN_CMD_PREPENDQ	|| \
		CMD == MEMCACHED_BIN_CMD_GATQ		|| \
		CMD == MEMCACHED_BIN_CMD_GATKQ		|| \
		CMD == MEMCACHED_BIN_CMD_RSETQ		|| \
		CMD == MEMCACHED_BIN_CMD_RAPPENDQ	|| \
		CMD == MEMCACHED_BIN_CMD_RPREPENDQ	|| \
		CMD == MEMCACHED_BIN_CMD_RDELETEQ	|| \
		CMD == MEMCACHED_BIN_CMD_RINCRQ		|| \
		CMD == MEMCACHED_BIN_CMD_RDECRQ)
